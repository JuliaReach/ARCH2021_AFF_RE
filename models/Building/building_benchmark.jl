...
Plots.plot!(fig, sol_BLDF01, vars=(0, 25),
            ...
            yformatter = y -> string(floor(Int, y/1e-3)), annotate=(0.5, 5e-3, text("⋅10⁻³", :left, 30)),
            bottom_margin=6mm, left_margin=5mm, right_margin=12mm, top_margin=3mm,
            size=(1000, 1000))
savefig(fig, joinpath(@__DIR__, "ARCH-COMP21-JuliaReach-Building_BLDF01_t20"))
...
Plots.plot!(fig, sol_BLDF01, vars=(0, 25),
            ...
            yformatter = y -> string(floor(Int, y/1e-3)), annotate=(0.025, 5e-3, text("⋅10⁻³", :left, 30)),
            bottom_margin=6mm, left_margin=5mm, right_margin=12mm, top_margin=3mm,
            size=(1000, 1000))
savefig(fig, joinpath(@__DIR__, "ARCH-COMP21-JuliaReach-Building_BLDF01_t1"))
...
savefig(fig, joinpath(@__DIR__, "ARCH-COMP21-JuliaReach-Building_BLDC01_t20"))
...
savefig(fig, joinpath(@__DIR__, "ARCH-COMP21-JuliaReach-Building_BLDC01_t1"));
